    ...
    <>
      <div className="mt-24 sm:mt-44 mx-10 sm:mx-20 lg:mx-32 2xl:mx-[245px] flex flex-col">
        <div>
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="w-[160px] h-fit flex flex-row justify-between">
              <a href={data?.facebookUrl} target="_">
                <FaFacebook className=" fill-brown-10" size={30} />
              </a>
              <a href={data?.linkedinUrl} target="_">
                <div className="w-[30px] h-[30px] flex items-center justify-center bg-brown-10 rounded-full">
                  <FaLinkedinIn className="fill-white" size={18} />
                </div>
              </a>
              <a href={data?.instagramUrl} target="_">
                <div className="w-[30px] h-[30px] flex items-center justify-center bg-brown-10 rounded-full">
                  <FaInstagram className="fill-white" size={21} />
                </div>
              </a>
              <a href={data?.youtubeUrl} target="_">
                <FaYoutube className=" fill-brown-10" size={30} />
              </a>
            </div>
          </div>
        ...
        <div className="my-6 flex flex-col md:flex-row-reverse items-center justify-between text-center sm:text-left">
          ...
          <div>
            <p className="font-normal leading-5 text-sm text-[#0A142F] uppercase">
